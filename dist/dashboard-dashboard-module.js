...
/* harmony import */ var _notifications_notifications_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./notifications/notifications.component */ "./src/app/layout/dashboard/notifications/notifications.component.ts");
/* harmony import */ var _notifications_notifications_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./notifications/notifications.service */ "./src/app/layout/dashboard/notifications/notifications.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/***/ "./src/app/layout/dashboard/notifications/notifications.component.css":
/*!****************************************************************************!*\
  !*** ./src/app/layout/dashboard/notifications/notifications.component.css ***!
  \****************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/layout/dashboard/notifications/notifications.component.html":
/*!*****************************************************************************!*\
  !*** ./src/app/layout/dashboard/notifications/notifications.component.html ***!
  \*****************************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"card-body\">\n    <div class=\"list-group\">\n        <a href=\"#\" class=\"list-group-item clearfix d-block\"  *ngFor=\"let notification of notifications\">\n            <i class=\"fa fa-comment fa-fw\"></i> \n            <strong>{{notification.DeviceId}}:</strong> {{notification.Text}}\n        \n            <span class=\"float-right text-muted small\">\n                <em>{{notification.Created}}</em>\n                &nbsp;<a class=\"fa fa-trash-o\" (click)=\"delete(notification.Id)\"></a>\n            </span>\n        </a>\n    </div>\n    <!-- /.list-group -->\n    <a (click)=\"showAll()\" class=\"btn btn-default btn-block\">View All Alerts</a>\n</div>"

/***/ }),

/***/ "./src/app/layout/dashboard/notifications/notifications.component.ts":
/*!***************************************************************************!*\
  !*** ./src/app/layout/dashboard/notifications/notifications.component.ts ***!
  \***************************************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _notifications_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./notifications.service */ "./src/app/layout/dashboard/notifications/notifications.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NotificationsComponent = /** @class */ (function () {
    ...
    NotificationsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.notificationsService.Get(10).subscribe(function (res) {
            _this.notifications = res;
        }, function (err) { return null; });
    };
    NotificationsComponent.prototype.showAll = function () {
        var _this = this;
        console.log("showAll clicked");
        this.notificationsService.GetAll().subscribe(function (res) {
            _this.notifications = res;
        }, function (err) { return null; });
    };
    NotificationsComponent.prototype.delete = function (id) {
        var _this = this;
        this.notificationsService.Delete(id).subscribe(function (res) {
            var index;
            _this.notifications.forEach(function (item) {
                if (item.Id === id) {
                    index = _this.notifications.indexOf(item);
                }
            });
    ...
    NotificationsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            providers: [_notifications_service__WEBPACK_IMPORTED_MODULE_1__["NotificationsService"]],
            selector: 'app-notifications',
            template: __webpack_require__(/*! ./notifications.component.html */ "./src/app/layout/dashboard/notifications/notifications.component.html"),
            styles: [__webpack_require__(/*! ./notifications.component.css */ "./src/app/layout/dashboard/notifications/notifications.component.css")]
        }),
...
/***/ "./src/app/layout/dashboard/notifications/notifications.service.ts":
/*!*************************************************************************!*\
  !*** ./src/app/layout/dashboard/notifications/notifications.service.ts ***!
  \*************************************************************************/
...
var NotificationsService = /** @class */ (function () {
    function NotificationsService(http) {
        ...
        this.host = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].services.sensorDataService.host;
        this.baseUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].services.sensorDataService.baseUrl;
    }
    NotificationsService.prototype.Get = function (maxResults) {
        var url = "" + this.host + this.baseUrl + "/Notifications/?maxResults=" + maxResults;
        return this.GetData(url);
    };
    NotificationsService.prototype.GetAll = function () {
        var url = "" + this.host + this.baseUrl + "/Notifications/";
        return this.GetData(url);
    };
    NotificationsService.prototype.GetData = function (url) {
        return this.http.get(url);
        //.map(res => res)
    };
    NotificationsService.prototype.Delete = function (id) {
        var url = "" + this.host + this.baseUrl + "/Notifications/" + id;
